...
public class CartPaymentsController extends BaseCommerceController
{
	...
	@Operation(operationId = "replaceCartPaymentDetails", summary = "Sets credit card payment details for the cart.", description = "Sets credit card payment details for the cart.")
	@ApiBaseSiteIdUserIdAndCartIdParam
